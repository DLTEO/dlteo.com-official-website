...
$(document).ready(function () {
    ...
    myearth.addEventListener( "ready", function() {
        ...
        const tooltip_opener = this.addOverlay( {
            content: '<div class="fs-s3 sm-fs-s1 md-fs-m1 lg-fs-m3">Developer & Scientist</div>',
        ...
        const tooltip_opener3 = this.addOverlay( {
            content: '<div class="fs-s3 sm-fs-s1 md-fs-m1 lg-fs-m3">Data miner & Crypto User</div>',
